  ...
  return (
    <div className="space-y-5 text-slate-800">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="text-xs font-bold text-slate-700 block mb-1">
            Monthly Pre/Post-tax Deductions ({currency})
          </label>
          <div className="relative">
      ...
      <div className="p-4 bg-slate-900 text-white rounded-2xl shadow-inner space-y-3">
        <div className="flex justify-between items-baseline">
          <div>
            <div className="text-xs font-bold text-slate-300">Monthly Take-Home:</div>
            <div className="text-[11px] text-slate-400">Deposited into your bank account</div>
          </div>
